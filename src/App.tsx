...
import { formatTimeElapsed } from "./helpers/formetTimeElapsed";
...
const App = () => {
    ...
    if (shownCount === 2) {
      ...
      if (opened.length === 2) {
        if (opened[0].item === opened[1].item) {
          // v1 if equals, make them permanent shown
  ...
  const resetAndCreateGrid = () => {
    // step 1: reseting game
    setTimeElapsed(0);
    setMoveCount(0);
    setShownCount(0);

    // step 2: creating grid and starting game
